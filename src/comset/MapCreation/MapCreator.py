...
class MapCreator:
    ...
    def __init__(self, configuration: Configuration):
        self.minimum_distance = 25  # Distance in meters used to group vertices together if they're too close
        self.intersections: Dict[
            int, Intersection
        ] = {}  # Map from id's to intersections. This represents the map.
        self.vertices: Dict[int, Vertex] = {}  # Map from id's to vertices.
        self.id_counter: int = 0  # Used to set id's of newly added vertices, such that they're always unique.
        self._projector: Optional[GeoProjector] = (
            None  # Used to project from lat, lon to x, y in meters
        )
    ...
    def _set_id_counter(self) -> None:
        """
        Set the id counter to the maximum id of the vertices plus one.
        """
        if self.vertices:
    ...
    def get_polygon_from_kml(polygon_kml_file: str) -> List[Tuple[float, float]]:
        ...
        Args:
            polygon_kml_file: a KML file defining a polygon
        Returns:
